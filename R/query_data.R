...
#' certain types of query data (e.g., student id, age, etc.), each of these
#' data types has a standard column name that must be supplied. Each column name
#' is listed below with associated query data.
#'
#' 'id' - student id
#'
